...
CREATE TABLE IF NOT EXISTS tasks (
  ...
  CONSTRAINT tasks_exactly_one_owner_check
    CHECK (
...
CREATE INDEX IF NOT EXISTS idx_files_lead_id
  ON files (lead_id);
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  CONSTRAINT notifications_entity_type_check
    CHECK (
      entity_type IS NULL OR entity_type IN ('task', 'lead', 'job', 'invite')
    )
);
